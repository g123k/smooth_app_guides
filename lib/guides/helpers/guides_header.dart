...
import 'package:smooth_guide/utils/num_utils.dart';
...
class _GuidesHeaderLayout extends MultiChildLayoutDelegate {
  ...
  void performLayout(Size size) {
    final double topMargin = topPadding + 10;
    final double maxHeight = size.height - topPadding - (10 * 2);
    ...
    positionChild(
      ...
      Offset(size.width * 0.6,
          topPadding + (maxHeight - illustrationSize.height) + 5),
    );

    positionChild(
      _GuidesHeaderLayoutId.minimizedTitle,
      Offset(
        _CloseButtonLayout._CLOSE_BUTTON_SIZE + 10,
        topMargin + 5,
      ),
    );
  }
